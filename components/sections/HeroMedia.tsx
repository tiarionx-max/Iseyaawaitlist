...
/**
 * Hero background: the real ISEYAA footage when conditions allow it,
 * layered over an illustrated landscape that acts as the poster/fallback —
 * shown immediately, kept under prefers-reduced-motion or a slow
 * connection, and left visible until the video can actually play so a
 * slow load never shows a black frame.
 */
...
/** Illustrated fallback shown before the video loads and under reduced motion. */
function OgunLandscape() {
  return (
    <>
      <svg
